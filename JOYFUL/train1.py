...
def main(args):
    ...
    if args.emotion:
        ...
        if args.transformers:
            ...
            args.data = os.path.join(
                args.data_dir_path, args.dataset, "data_" + args.dataset + "_" + args.name+ ".pkl"
            )
    ...
    modelF= AutoFusion(args, args.fusion_embedding_dims[args.dataset][args.modalities], 460*len(args.modalities))
...
if __name__ == "__main__":
    ...
    parser.add_argument(
        ...
        help="name of pkl file after data_dataset_name",
    )
    parser.add_argument(
        "--dataset",
        type=str,
